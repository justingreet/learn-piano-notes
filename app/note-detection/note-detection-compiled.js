...
noteDetectionModule.controller('NoteDetectionController', ['noteDetectorService', function (noteDetectorService) {
  var self = this;
  ...
  this.init = function () {
     ...
     */
    var initDetection = function initDetection(stream) {
